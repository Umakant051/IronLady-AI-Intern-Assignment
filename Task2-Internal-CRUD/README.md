...
cd IronLady-AI-Intern-Assignment/Task2-Internal-CRUD
...
##### 7\. Use the interface to create, view, update, and delete enquiries.



Note: The application uses SQLite for persistent storage, and the database is created automatically at runtime.
